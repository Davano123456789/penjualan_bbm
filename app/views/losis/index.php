        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex flex-col p-4 bg-slate-50 rounded-2xl">
                        <span class="text-[9px] font-black text-slate-400 uppercase mb-2">Total DO (Penerimaan)</span>
                    ...
                    <div class="flex flex-col p-4 bg-blue-50 border border-blue-100 rounded-2xl relative">
                        <div class="absolute -top-2 left-4 px-2 py-0.5 bg-blue-600 text-white text-[8px] font-black rounded-lg uppercase">Total Stok Buku</div>
